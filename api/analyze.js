export default async function handler(req, res) {
  ...
  try {
    const { topTalents, allScores, customPrompt } = req.body;
    ...
    if (customPrompt) {
      ...
      prompt = `Ти — провідний коуч з розвитку особистості та кар'єри. Проведи глибокий аналіз профілю людини за результатами тесту сильних сторін.
...
### Три кроки розвитку
Три конкретних практичних дії, які ця людина може зробити вже цього тижня.
